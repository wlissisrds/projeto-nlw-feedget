...
//paramestro e funcoes recebida do component pai como props
...
export function ScreenshotButton({
  ...
  async function handleTakeScreenshot() {
    ...
    //passando a imagem em texto para o component pai (FeedbackContentStep.tsx)
